...
//
// Add new paper: append { year: year, content: `HTML content` } to the array
// Citations [C1], [C2]... are auto-generated based on sorted order
// ============================================================
const CONFERENCES = [
  {
    year: 2024,
...
//
// Add new paper: append { year: year, content: `HTML content` } to the array
// Citations [J1], [J2]... are auto-generated based on sorted order
// ============================================================
const JOURNALS = [
  {
    year: 2025,
...
function renderPublications() {
  ...
  var sortedConf = CONFERENCES.map(function(p, i) {
    return { year: p.year, content: p.content, _idx: i };
  }).sort(sortFn);
